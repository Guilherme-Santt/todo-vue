<template>
    <div :class="['container-body']">
        <div v-if="data.length > 0">
            ...
            <button @click="emit('cleanAllTodo')" v-if="data.length > 1" :class="['container-button']">Limpar todas tarefas</button>
        </div>
        <div v-else>
...
<script setup>
    ...
    const emit = defineEmits(['deleteTodo', 'confirmTodo', 'cleanAllTodo'])
...
<style>
    ...
    .container-button:hover {
        ...
        box-shadow: 0 4px 12px rgba(245, 38, 38, 0.4);
    }
</style>